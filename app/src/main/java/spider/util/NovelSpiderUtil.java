...
import com.example.spidersnovel.BaseApplication;
...
public class NovelSpiderUtil {
    ...
    private static void init() {
        try {
            FileUtils.getInstance(BaseApplication.getAppContext()).copyAssetsToSD("","app/");
            SAXReader reader = new SAXReader();
            Document document = reader.read(new File(Environment.getExternalStorageDirectory() + "/app/Spider-Rule.xml"));
